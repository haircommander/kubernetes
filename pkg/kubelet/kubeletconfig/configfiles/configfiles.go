...
type Loader interface {
	...
	// LoadIntoJSON loads and returns the KubeletConfiguration from the storage layer, or an error if a configuration could not be loaded
	// It returns the configuration as a JSON byte slice
